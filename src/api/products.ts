...
import type {CreateProductParams, CreateProductResponse, EditProductParams, GetProductsResponse,EditProductResponse, DeleteProductResponse, UploadImageResponse} from '@/types/product'
